...
export default function Home() {
  return (
    <main className="overflow-x-hidden">
      <section className="pt-32 pb-20 px-6 lg:px-12 max-w-screen-xl mx-auto">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-full border border-ink/15 px-5 py-3 font-mono text-[11px] uppercase tracking-[0.18em] text-ink transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-bg-card active:scale-[0.98]"
          >
            GitHub
          </a>
          <a
      ...
      <section className="pt-20 pb-32 px-6 lg:px-12 max-w-screen-xl mx-auto">
      ...
      <section id="about" className="py-28 px-6 lg:px-12 max-w-screen-xl mx-auto">
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
          <div className="border border-ink/[0.08] p-5">
            <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-ink-faint mb-3">Education</p>
